...
N_OF_CALIB_SIMS = 100    # total number of trajectories to simulate as part of calibration
N_OF_SIMS = 15   # number of trajectories to simulate using the calibrated model
