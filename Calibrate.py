...
N_OF_CALIB_SIMS = 10000    # total number of trajectories to simulate as part of calibration
N_OF_SIMS = 1000   # number of trajectories to simulate using the calibrated model
